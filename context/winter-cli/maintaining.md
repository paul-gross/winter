...
| **Add or change a destructive command**      | The destructive-verb enumeration in [worktree-ops.md § Verifying destructive commands safely](../worktree-ops.md#verifying-destructive-commands-safely); a `winter:manual` method section declaring it in `winter-context:/verification/winter.md`. |
