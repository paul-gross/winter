...
`winter --winter=<path> …` runs the winter-cli from `<path>/tools/winter-cli` against the current workspace instead of the installed core. Primary use: testing a feature-branch core change without reinstalling. Example:
